...
-- Generated: 2026-01-15T02:30:07.281710
-- Database: postgres
...
-- Description: Глобальные настройки Q&A приложения (ключ-значение)
...
COMMENT ON TABLE public.qa_app_settings IS 'Глобальные настройки Q&A приложения (ключ-значение)';
COMMENT ON COLUMN public.qa_app_settings.key IS 'Ключ настройки (например: gemini_api_key, max_history_pairs)';
COMMENT ON COLUMN public.qa_app_settings.value IS 'Значение настройки в текстовом формате';
COMMENT ON COLUMN public.qa_app_settings.value_type IS 'Тип значения: string, int, bool, json';
COMMENT ON COLUMN public.qa_app_settings.description IS 'Описание настройки для администратора';
COMMENT ON COLUMN public.qa_app_settings.updated_at IS 'Дата и время последнего обновления';

-- Table: public.qa_artifacts
-- Description: Артефакты (файлы), созданные в процессе диалога
...
COMMENT ON TABLE public.qa_artifacts IS 'Артефакты (файлы), созданные в процессе диалога';
COMMENT ON COLUMN public.qa_artifacts.id IS 'Уникальный идентификатор артефакта';
COMMENT ON COLUMN public.qa_artifacts.conversation_id IS 'Ссылка на диалог';
COMMENT ON COLUMN public.qa_artifacts.artifact_type IS 'Тип артефакта (image, document и др.)';
COMMENT ON COLUMN public.qa_artifacts.r2_key IS 'Ключ объекта в R2 storage';
COMMENT ON COLUMN public.qa_artifacts.file_name IS 'Имя файла для отображения';
COMMENT ON COLUMN public.qa_artifacts.mime_type IS 'MIME тип файла';
COMMENT ON COLUMN public.qa_artifacts.file_size IS 'Размер файла в байтах';
COMMENT ON COLUMN public.qa_artifacts.metadata IS 'Дополнительные метаданные (JSON)';
COMMENT ON COLUMN public.qa_artifacts.created_at IS 'Дата и время создания';

-- Table: public.qa_clients
-- Description: Клиенты Q&A приложения
...
COMMENT ON TABLE public.qa_clients IS 'Клиенты Q&A приложения';
COMMENT ON COLUMN public.qa_clients.id IS 'Уникальный идентификатор записи';
COMMENT ON COLUMN public.qa_clients.client_id IS 'Текстовый идентификатор клиента';
COMMENT ON COLUMN public.qa_clients.api_token IS 'API токен для аутентификации';
COMMENT ON COLUMN public.qa_clients.name IS 'Отображаемое имя клиента';
COMMENT ON COLUMN public.qa_clients.default_model IS 'Модель по умолчанию для диалогов';
COMMENT ON COLUMN public.qa_clients.is_active IS 'Флаг активности клиента';
COMMENT ON COLUMN public.qa_clients.created_at IS 'Дата и время регистрации';
COMMENT ON COLUMN public.qa_clients.updated_at IS 'Дата и время последнего обновления';
...
COMMENT ON COLUMN public.qa_conversation_context_files.id IS 'Уникальный идентификатор записи';
COMMENT ON COLUMN public.qa_conversation_context_files.conversation_id IS 'Ссылка на диалог';
COMMENT ON COLUMN public.qa_conversation_context_files.node_file_id IS 'Ссылка на файл узла (node_files)';
...
COMMENT ON COLUMN public.qa_conversation_context_files.uploaded_at IS 'Дата и время загрузки в Gemini';
COMMENT ON COLUMN public.qa_conversation_context_files.created_at IS 'Дата и время создания записи';

-- Table: public.qa_conversation_gemini_files
-- Description: Связь диалогов с файлами в Gemini Files API
...
COMMENT ON TABLE public.qa_conversation_gemini_files IS 'Связь диалогов с файлами в Gemini Files API';
COMMENT ON COLUMN public.qa_conversation_gemini_files.id IS 'Уникальный идентификатор связи';
COMMENT ON COLUMN public.qa_conversation_gemini_files.conversation_id IS 'Ссылка на диалог';
COMMENT ON COLUMN public.qa_conversation_gemini_files.gemini_file_id IS 'Ссылка на файл в qa_gemini_files';
COMMENT ON COLUMN public.qa_conversation_gemini_files.added_at IS 'Дата и время добавления файла';

-- Table: public.qa_conversation_nodes
-- Description: Связь диалогов с узлами дерева проектов
...
COMMENT ON TABLE public.qa_conversation_nodes IS 'Связь диалогов с узлами дерева проектов';
COMMENT ON COLUMN public.qa_conversation_nodes.id IS 'Уникальный идентификатор связи';
COMMENT ON COLUMN public.qa_conversation_nodes.conversation_id IS 'Ссылка на диалог';
COMMENT ON COLUMN public.qa_conversation_nodes.node_id IS 'Ссылка на узел дерева';
COMMENT ON COLUMN public.qa_conversation_nodes.added_at IS 'Дата и время добавления узла';

-- Table: public.qa_conversations
-- Description: Диалоги (разговоры) с AI моделью
...
COMMENT ON TABLE public.qa_conversations IS 'Диалоги (разговоры) с AI моделью';
COMMENT ON COLUMN public.qa_conversations.id IS 'Уникальный идентификатор диалога';
COMMENT ON COLUMN public.qa_conversations.client_id IS 'Идентификатор клиента-владельца';
COMMENT ON COLUMN public.qa_conversations.title IS 'Заголовок диалога';
COMMENT ON COLUMN public.qa_conversations.model_default IS 'Модель по умолчанию для этого диалога';
COMMENT ON COLUMN public.qa_conversations.created_at IS 'Дата и время создания диалога';
COMMENT ON COLUMN public.qa_conversations.updated_at IS 'Дата и время последнего сообщения';

-- Table: public.qa_gemini_files
-- Description: Файлы, загруженные в Gemini Files API
...
COMMENT ON TABLE public.qa_gemini_files IS 'Файлы, загруженные в Gemini Files API';
COMMENT ON COLUMN public.qa_gemini_files.id IS 'Уникальный идентификатор записи';
COMMENT ON COLUMN public.qa_gemini_files.client_id IS 'Идентификатор клиента-владельца';
COMMENT ON COLUMN public.qa_gemini_files.gemini_name IS 'Имя файла в Gemini API (files/xyz123)';
COMMENT ON COLUMN public.qa_gemini_files.gemini_uri IS 'URI файла в Gemini API';
COMMENT ON COLUMN public.qa_gemini_files.display_name IS 'Отображаемое имя файла';
COMMENT ON COLUMN public.qa_gemini_files.mime_type IS 'MIME тип файла';
COMMENT ON COLUMN public.qa_gemini_files.size_bytes IS 'Размер файла в байтах';
COMMENT ON COLUMN public.qa_gemini_files.sha256 IS 'SHA256 хеш содержимого файла';
COMMENT ON COLUMN public.qa_gemini_files.source_node_file_id IS 'Ссылка на исходный файл в node_files';
COMMENT ON COLUMN public.qa_gemini_files.source_r2_key IS 'Исходный ключ файла в R2';
COMMENT ON COLUMN public.qa_gemini_files.created_at IS 'Дата и время загрузки';
COMMENT ON COLUMN public.qa_gemini_files.updated_at IS 'Дата и время последнего обновления';
COMMENT ON COLUMN public.qa_gemini_files.expires_at IS 'Дата и время истечения срока хранения';
...
COMMENT ON COLUMN public.qa_jobs.id IS 'Уникальный идентификатор задачи';
COMMENT ON COLUMN public.qa_jobs.conversation_id IS 'Ссылка на диалог';
COMMENT ON COLUMN public.qa_jobs.client_id IS 'Идентификатор клиента';
COMMENT ON COLUMN public.qa_jobs.user_text IS 'Текст запроса пользователя';
COMMENT ON COLUMN public.qa_jobs.system_prompt IS 'Системный промпт для модели';
COMMENT ON COLUMN public.qa_jobs.user_text_template IS 'Шаблон пользовательского промпта';
COMMENT ON COLUMN public.qa_jobs.model_name IS 'Название используемой модели';
COMMENT ON COLUMN public.qa_jobs.thinking_level IS 'Уровень размышлений: low, medium, high';
COMMENT ON COLUMN public.qa_jobs.thinking_budget IS 'Лимит токенов на размышления';
COMMENT ON COLUMN public.qa_jobs.file_refs IS 'Ссылки на прикрепленные файлы (JSON)';
COMMENT ON COLUMN public.qa_jobs.status IS 'Job status: queued, processing, completed, failed';
COMMENT ON COLUMN public.qa_jobs.progress IS 'Прогресс выполнения (0.0 - 1.0)';
COMMENT ON COLUMN public.qa_jobs.result_message_id IS 'FK to the assistant message created when job completes';
COMMENT ON COLUMN public.qa_jobs.result_text IS 'Текст ответа модели';
COMMENT ON COLUMN public.qa_jobs.result_actions IS 'Извлеченные действия из ответа (JSON)';
COMMENT ON COLUMN public.qa_jobs.result_is_final IS 'Флаг финального ответа';
COMMENT ON COLUMN public.qa_jobs.error_message IS 'Текст ошибки при status=failed';
COMMENT ON COLUMN public.qa_jobs.retry_count IS 'Количество попыток выполнения';
COMMENT ON COLUMN public.qa_jobs.max_retries IS 'Максимальное количество попыток';
COMMENT ON COLUMN public.qa_jobs.created_at IS 'Дата и время создания задачи';
COMMENT ON COLUMN public.qa_jobs.started_at IS 'Дата и время начала обработки';
COMMENT ON COLUMN public.qa_jobs.completed_at IS 'Дата и время завершения';
COMMENT ON COLUMN public.qa_jobs.updated_at IS 'Дата и время последнего обновления';
...
-- Description: Сообщения в диалогах
...
COMMENT ON TABLE public.qa_messages IS 'Сообщения в диалогах';
COMMENT ON COLUMN public.qa_messages.id IS 'Уникальный идентификатор сообщения';
COMMENT ON COLUMN public.qa_messages.conversation_id IS 'Ссылка на диалог';
COMMENT ON COLUMN public.qa_messages.role IS 'Роль отправителя: user, assistant, system';
COMMENT ON COLUMN public.qa_messages.content IS 'Текст сообщения';
COMMENT ON COLUMN public.qa_messages.meta IS 'Метаданные сообщения (JSON)';
COMMENT ON COLUMN public.qa_messages.created_at IS 'Дата и время отправки';
...
COMMENT ON COLUMN public.qa_model_traces.id IS 'Уникальный идентификатор трассировки';
COMMENT ON COLUMN public.qa_model_traces.ts IS 'Timestamp when the request was initiated';
COMMENT ON COLUMN public.qa_model_traces.conversation_id IS 'Ссылка на диалог';
COMMENT ON COLUMN public.qa_model_traces.client_id IS 'Идентификатор клиента';
COMMENT ON COLUMN public.qa_model_traces.model IS 'Название модели';
COMMENT ON COLUMN public.qa_model_traces.thinking_level IS 'Уровень размышлений модели';
COMMENT ON COLUMN public.qa_model_traces.system_prompt IS 'Системный промпт запроса';
COMMENT ON COLUMN public.qa_model_traces.user_text IS 'Текст пользовательского запроса';
...
COMMENT ON COLUMN public.qa_model_traces.latency_ms IS 'Задержка ответа в миллисекундах';
COMMENT ON COLUMN public.qa_model_traces.errors IS 'Array of error messages if any';
COMMENT ON COLUMN public.qa_model_traces.is_final IS 'Флаг финального ответа в цепочке';
COMMENT ON COLUMN public.qa_model_traces.assistant_text IS 'Текст ответа ассистента';
COMMENT ON COLUMN public.qa_model_traces.full_thoughts IS 'Полный текст размышлений модели';
COMMENT ON COLUMN public.qa_model_traces.input_tokens IS 'Количество входных токенов';
COMMENT ON COLUMN public.qa_model_traces.output_tokens IS 'Количество выходных токенов';
COMMENT ON COLUMN public.qa_model_traces.total_tokens IS 'Общее количество токенов';
COMMENT ON COLUMN public.qa_model_traces.created_at IS 'Дата и время создания записи';
...
-- Description: Пользовательские промпты для AI диалогов
...
COMMENT ON TABLE public.user_prompts IS 'Пользовательские промпты для AI диалогов';
COMMENT ON COLUMN public.user_prompts.id IS 'Уникальный идентификатор промпта';
COMMENT ON COLUMN public.user_prompts.title IS 'Заголовок промпта';
COMMENT ON COLUMN public.user_prompts.system_prompt IS 'Системный промпт';
COMMENT ON COLUMN public.user_prompts.user_text IS 'Пользовательский текст промпта';
COMMENT ON COLUMN public.user_prompts.r2_key IS 'Ключ в R2 storage для полного содержимого';
COMMENT ON COLUMN public.user_prompts.created_at IS 'Дата и время создания промпта';
