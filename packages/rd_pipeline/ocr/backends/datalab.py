...
3. **Abbreviations**: Keep Russian technical acronyms exactly as printed: "MXMTC", "BKT", "PUI", "VRU", "LK", "S/u". Do not expand them.
4. **OCR Correction**: Fix ONLY visual character errors typical for Cyrillic OCR:
   - '0' (digit) vs 'O' (letter)
   - '3' (digit) vs 'Z' (letter)
   - 'б' (letter) vs '6' (digit)
   - 'м2' -> 'м²'
5. **Drawings**: If the image is a drawing (e.g., parking layout), output a bulleted list of text labels and dimensions found (e.g., "- Small m/m: 2600x5300").
