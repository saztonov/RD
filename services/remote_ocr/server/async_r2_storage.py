...
class AsyncR2Storage:
    ...
    async def upload_file(self, local_path: str, remote_key: str, content_type: Optional[str] = None) -> bool:
    ...
    async def upload_text(self, content: str, remote_key: str, content_type: Optional[str] = None) -> bool:
...
class AsyncR2StorageSync:
    ...
    def upload_file(self, local_path: str, remote_key: str, content_type: Optional[str] = None) -> bool:
        return _run_async(self._async_storage.upload_file(local_path, remote_key, content_type))
    
    def download_text(self, remote_key: str) -> Optional[str]:
        return _run_async(self._async_storage.download_text(remote_key))
    
    def upload_text(self, content: str, remote_key: str, content_type: Optional[str] = None) -> bool:
        return _run_async(self._async_storage.upload_text(content, remote_key, content_type))
