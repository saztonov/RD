...
- Подробнее: [`prompts/README.md`](prompts/README.md)
...
### Быстрый старт
- **[Marker + OCR workflow](docs/QUICK_START_MARKER_OCR.md)** — разметка и OCR по типам блоков ⭐
- **[Базовое использование](docs/QUICK_START.md)** — функции рендеринга

### Интеграции OCR
- **[Marker + OCR интеграция](docs/MARKER_OCR_INTEGRATION.md)** — обработка по типам блоков
...
### Архитектура
- **[PDF Рендеринг](docs/pdf_rendering.md)** — документация по `pdf_utils.py`
- **[Модели данных](docs/DATA_MODELS.md)** — структуры Block, PageModel, координаты

### Примеры кода
- **[Marker + OCR workflow](examples/test_marker_ocr_workflow.py)** — полный пример
- **[PDF рендеринг](examples/test_pdf_rendering.py)** — примеры рендеринга
- **[Модели данных](examples/test_models.py)** — работа с блоками
...
1. ✅ **Редактируемые промпты OCR** - настройка через файлы в `prompts/`
2. ✅ **Marker + OCR интеграция** - обработка блоков по типам
3. ✅ **IMAGE распознавание** - детальное описание на русском через Qwen
4. ✅ **Структурированный Markdown** - генерация с описаниями изображений
5. ✅ Интеграция Chandra OCR
