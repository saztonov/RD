...
📖 **[Быстрый старт](QUICKSTART.md)** | 📚 **[Полная документация](docs/)** | 📝 **[История изменений](CHANGELOG.md)** | ℹ️ **[О продукте](ABOUT.md)**
...
- **client_id:** уникальный ID клиента (`~/.config/CoreStructure/client_id.txt`)
...
- [`ABOUT.md`](ABOUT.md) — подробная информация о продукте
...
Подробнее см. [`ABOUT.md`](ABOUT.md)
