...
1. ✅ **Marker + OCR интеграция** - обработка блоков по типам
2. ✅ **IMAGE распознавание** - детальное описание на русском через Qwen
3. ✅ **Структурированный Markdown** - генерация с описаниями изображений
4. ✅ Интеграция Chandra OCR
