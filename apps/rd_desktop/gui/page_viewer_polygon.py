...
class PolygonMixin:
    ...
    def _add_polygon_point(self, point: QPointF):
        ...
        if len(self.polygon_points) > 1:
            ...
            line = QGraphicsLineItem(
                prev_point.x(), prev_point.y(), clamped_point.x(), clamped_point.y()
            )
    ...
    def _update_polygon_temp_line(self, current_pos: QPointF):
        ...
        self.polygon_temp_line = QGraphicsLineItem(
            last_point.x(), last_point.y(), current_pos.x(), current_pos.y()
        )
    ...
    def _get_polygon_vertex_handle(
        self, pos: QPointF, points: List[tuple]
    ) -> Optional[int]:
