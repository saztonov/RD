...
from apps.rd_desktop.gui.block_handlers import BlockHandlersMixin
from apps.rd_desktop.gui.blocks_tree_manager import BlocksTreeManager
from apps.rd_desktop.gui.file_operations import FileOperationsMixin
from apps.rd_desktop.gui.menu_setup import MenuSetupMixin
from apps.rd_desktop.gui.navigation_manager import NavigationManager
from apps.rd_desktop.gui.panels_setup import PanelsSetupMixin
from apps.rd_desktop.gui.remote_ocr.panel import RemoteOCRPanel
...
class MainWindow(
    ...
    def _show_folder_settings(self):
        ...
        from apps.rd_desktop.gui.folder_settings_dialog import FolderSettingsDialog
    ...
    def _show_tree_settings(self):
        ...
        from apps.rd_desktop.gui.tree_settings_widget import TreeSettingsWidget
    ...
    def _show_version_settings(self):
        ...
        from apps.rd_desktop.gui.folder_settings_dialog import VersionSettingsDialog
    ...
    def _show_ocr_settings(self):
        ...
        from apps.rd_desktop.gui.ocr_settings_dialog import OCRSettingsDialog
    ...
    def _show_image_categories(self):
        ...
        from apps.rd_desktop.gui.image_categories_dialog import ImageCategoriesDialog
    ...
    def _show_hotkeys_dialog(self):
        ...
        from apps.rd_desktop.gui.hotkeys_dialog import HotkeysDialog
    ...
    def _start_r2_reconciliation(self):
        ...
        from apps.rd_desktop.gui.project_tree.reconciliation_manager import get_reconciliation_manager
        from apps.rd_desktop.tree_client import NodeType
    ...
    def _setup_connection_manager(self):
        ...
        from apps.rd_desktop.gui.connection_manager import ConnectionManager, ConnectionStatus
    ...
    def _on_connection_restored(self):
        ...
        from apps.rd_desktop.gui.toast import show_toast
        from apps.rd_desktop.gui.sync_queue import get_sync_queue
    ...
    def _on_connection_status_changed(self, status):
        ...
        from apps.rd_desktop.gui.connection_manager import ConnectionStatus
    ...
    def _sync_pending_operations(self):
        ...
        def sync_operation(operation):
            try:
                from apps.rd_desktop.gui.sync_queue import SyncOperationType
    ...
    def _register_synced_annotation(self, node_id: str, r2_key: str, local_path: str):
        ...
        try:
            from pathlib import Path
            from apps.rd_desktop.tree_client import FileType, TreeClient
