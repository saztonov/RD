...
from apps.rd_desktop.gui.ocr_preview_widget import OcrPreviewWidget
from apps.rd_desktop.gui.page_viewer import PageViewer
from apps.rd_desktop.gui.project_tree import ProjectTreeWidget
