...
class JobOperationsMixin:
    ...
    def _clean_old_ocr_results(self, node_id: str, r2_key: str, r2):
        ...
        try:
            ...
            if self.main_window.annotation_document:
                ...
                if cleared > 0:
                    from apps.rd_desktop.gui.file_operations import (
                        get_annotation_path,
    ...
    def _create_job(self):
        ...
        from apps.rd_desktop.gui.ocr_dialog import OCRDialog
        ...
        from apps.rd_desktop.ocr_client import JobInfo
    ...
    def _create_job_bg(
        ...
        try:
            from apps.rd_desktop.ocr_client import (
                AuthenticationError,
    ...
    def _show_job_details(self, job_id: str):
        ...
        try:
            ...
            from apps.rd_desktop.gui.job_details_dialog import JobDetailsDialog
