...
from apps.rd_desktop.gui.tree_node_operations import NODE_ICONS, STATUS_COLORS
...
class TreeItemBuilder:
    ...
    def _format_document(self, node: TreeNode, icon: str) -> tuple:
        ...
        from apps.rd_desktop.gui.project_tree.pdf_status_manager import PDFStatusManager
