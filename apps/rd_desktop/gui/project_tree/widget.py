...
from apps.rd_desktop.gui.tree_context_menu import TreeContextMenuMixin
from apps.rd_desktop.gui.tree_delegates import VersionHighlightDelegate
from apps.rd_desktop.gui.tree_filter_mixin import TreeFilterMixin
from apps.rd_desktop.gui.tree_node_operations import STATUS_COLORS, TreeNodeOperationsMixin
from apps.rd_desktop.gui.tree_sync_mixin import TreeSyncMixin
from apps.rd_desktop.tree_client import NodeType, TreeClient, TreeNode
...
class ProjectTreeWidget(
    ...
    def _verify_blocks(self, node: TreeNode):
        from apps.rd_desktop.gui.block_verification_dialog import BlockVerificationDialog
    ...
    def _reconcile_files(self, node: TreeNode):
        ...
        from apps.rd_desktop.gui.file_reconciliation_dialog import FileReconciliationDialog
