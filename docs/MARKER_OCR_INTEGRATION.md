...
Все промпты хранятся в папке `prompts/`:
...
**IMAGE блоки** (`prompts/ocr_image_description.txt`):
```
...
**TEXT блоки** (`prompts/ocr_text.txt`):
```
...
**TABLE блоки** (`prompts/ocr_table.txt`):
```
