...
class R2DownloadWorker(QThread):
    ...
    def __init__(self, files_to_download: list, target_dir: Path):
        super().__init__()
    ...
    def run(self):
        ...
        try:
            ...
            for i, file_info in enumerate(self.files_to_download):
                ...
                if r2.download_file(r2_key, str(local_path)):
                    downloaded += 1
            
            self.finished.emit(True, f"Скачано {downloaded}/{total} файлов")
