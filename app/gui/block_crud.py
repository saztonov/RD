...
from rd_core.models import Block, BlockSource, BlockType, Page, ShapeType
...
class BlockCRUDMixin:
    ...
    def _on_block_drawn(self, x1: int, y1: int, x2: int, y2: int):
        ...
        logger.debug(
            f"Block created: {block.id} coords_px={block.coords_px} page_size={current_page_data.width}x{current_page_data.height}"
        )
